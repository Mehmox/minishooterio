export default function Button({ children, ...props }) {
    return <button {...props} className="w-input h-16 inline-block relative cursor-pointer opacity-90 hover:opacity-100 transition-opacity p-[2px] bg-black rounded-[16px] bg-gradient-to-t from-[#8122b0] to-[#dc98fd] active:scale-95 justify-center">
