//decoder.js
import { read_schema } from "../../shared/BufferShema";
...
export default function decoder(snapshot, Gamestate) {
        ...
        for (let i = 0; i < property_num; i++) {
            ...
            switch (property) {
                ...
                default:
                    ...
                    console.log(Gamestate[entity_id][property])
                    Gamestate[entity_id][property] = patch[getMetod](offset, true);//değişen verinin değeri
                    // console.log(Gamestate[entity_id][property_variable])


                    offset += read_schema[property_id].byte;
