import fs from "fs";
const all_game_settings = JSON.parse(fs.readFileSync("./game_settings.json", "utf8"));
import markDirty from "../utils/markDirty.js";

const game_settings = all_game_settings.map;

export default function Move(players) {
